...
<head>
  ...
  <title>@yield('title') Roab. - Admin</title>
  ...
  <div class="d-flex min-vh-100">
    <div class="d-flex flex-column flex-shrink-0 p-3 text-bg-primary" style="max-width: 280px;" data-bs-theme="dark">
      <a href="/" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-white text-decoration-none justify-content-center">
        ...
        <span class="fs-4 d-none d-sm-inline-block">Roab.</span>
      </a>
      <hr>
      <ul class="nav nav-pills flex-column mb-auto" data-bs-themes>
        <li class="nav-item">
          <a href="{{ route('admin') }}" class="nav-link rounded-0 {{(Request::routeIs('admin'))?'active':'text-white'}} " aria-current="page">
            <i class="far fa-tachometer-alt-fastest fa-fw"></i>
            <span class="d-none d-sm-inline-block">Dashboard</span>
          </a>
        </li>
        <li>
          <a href="{{ route('admin.orders.index') }}" class="nav-link rounded-0 {{(Request::routeIs('admin.orders.index'))?'active':'text-white'}}">
            <i class="far fa-shopping-cart fa-fw"></i>
            <span class="d-none d-sm-inline-block">Orders</span>
          </a>
        </li>
        <li>
          <a href="{{ route('admin.products') }}" class="nav-link rounded-0 {{(Request::routeIs('admin.products'))?'active':'text-white'}}">
            <i class="far fa-boxes fa-fw"></i>
            <span class="d-none d-sm-inline-block">Products</span>
          </a>
        </li>
        <li>
          <a href="{{ route('admin.users') }}" class="nav-link rounded-0 {{(Request::routeIs('admin.users'))?'active':'text-white'}}">
